package org.d3if4501.mobpro2.ui.screen
...
fun getMessage(context: Context, nama: String, kategori: Kategori): String {
    ...
    return context.getString(R.string.hasil, nama,
        kategori.toString().uppercase())
}
...
enum class Kategori { BAYI, BALITA, ANAK, REMAJA, DEWASA, LANSIA, INVALID }
